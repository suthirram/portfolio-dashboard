...
* A backdated ledger edit triggers `healSnapshots` → `RecomputeFrom`, which rewrites stored snapshots from the earliest affected date so history stays consistent.
